...
?>
    ...
    ?>
        ...
        -->
            ...
            <head>
                <meta charset="utf-8" />
                <title><?php echo escape($data->fac_name) ?> | Event Participated</title>
                                        ...
                                        <div class="card card-custom card-stretch">
                                            ...
                                            <div class="card-body pt-4">
                                                ...
                                                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="efp_event.php?emd_department_hash=<?php echo escape(convert_string('decrypt', $data->fac_passkey)); ?>&em_admin=admin" class="navi-link py-4 active" data-toggle="tooltip" title="Event Participates" data-placement="right">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                        ...
                                        <div class="card card-custom card-border gutter-b">
                                            ...
                                            <div class="card-header border-0 py-5">
                                                <h3 class="card-title align-items-start flex-column">
                                                    ...
                                                    <span class="text-muted mt-3 font-weight-bold font-size-sm">More than <?php echo $user->fac_fevent_part($data->fac_passkey); ?>+ new event</span>
                                                </h3>
                                            </div>
                                            <!--end::Header-->
                                            <!--begin::Body-->
