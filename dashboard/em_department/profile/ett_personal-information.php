...
?>
    ...
    ?>
            ...
            <head>
                <meta charset="utf-8" />
                <title><?php echo escape($data->dept_name) ?> | Personal Information</title>
                ...
                <div class="d-flex flex-column-fluid flex-column flex-row-fluid wrapper" id="kt_wrapper">
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="subheader py-2 py-lg-6 subheader-transparent" id="kt_subheader">
                            <div class="container d-flex align-items-start justify-content-start flex-wrap flex-sm-nowrap">
                                <!--begin::Info-->
                                        ...
                                        <div class="card card-custom card-stretch">
                                            ...
                                            <div class="card-body pt-4">
                                                ...
                                                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="ett_personal-information.php?emd_department_hash=<?php echo escape(convert_string('decrypt', $data->dept_hash)); ?>&em_admin=admin" class="navi-link py-4 active">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                            ...
                                            <div class="card card-custom card-stretch" id="kt_page_sticky_card">
                                                ...
                                                <div class="card-header py-3">
                                                    <div class="card-title align-items-start flex-column">
                                                        ...
                                                        <span class="text-muted font-weight-bold font-size-sm mt-1">Update Department personal information</span>
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-6">
                                                            <?php if ($data->dept_image) { ?>
                                                                <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url(data:image/png;base64,<?php echo escape(base64_encode($data->dept_image)); ?>)">
                                                                <?php } else { ?>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control form-control-lg form-control-solid" type="text" name="te_name" id="te_name" value="<?php echo escape($data->dept_name); ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Department Short Name</label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control form-control-lg form-control-solid" type="text" name="te_sname" id="te_sname" value="<?php echo escape($data->dept_sname); ?>" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="input-group input-group-lg input-group-solid">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-lg form-control-solid" value="<?php echo escape($data->dept_phone); ?>" placeholder="Phone" name="te_phone" id="te_phone" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="input-group input-group-lg input-group-solid">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-lg form-control-solid" value="<?php echo escape($data->dept_email); ?>" placeholder="Email" name="te_email" id="te_email" />
                                                                </div>
                                                                <span class="form-text text-muted">We'll never share your email with anyone else.</span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Teacher Site</label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="input-group input-group-lg input-group-solid">
                                                                    <input type="text" class="form-control form-control-lg form-control-solid" placeholder="Website" value="<?php echo escape($data->dept_site); ?>" name="te_website" id="te_website" />
                                                                    <div class="input-group-append">
                                                ...
                                                <div class="card-footer">
                                                    <div class="card-toolbar">
                                                        ...
                                                        <input type="hidden" name="ett_token" id="ett_token" value="<?php echo escape(convert_string('decrypt', $data->dept_hash)); ?>" />
                                                        <input type="hidden" name="ett_passkey" id="ett_passkey" value="<?php echo escape(convert_string('decrypt', $data->dept_passkey)); ?>" />
