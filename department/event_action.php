    ...
    if (Input::get('action') == 'add_event') {
        ...
        if ($validate->passed()) {
            try {
                ...
                if(!empty($_FILES['e_image']['tmp_name']) && file_exists($_FILES['e_image']['tmp_name'])){ 
                    $dir_name = 'upload/';
                ...
                $fe_event = $db->insert('dept_event', array(
                    ...
                    'fe_fac_hash' => convert_string('encrypt', Input::get('e_mentor')),
                    'fe_dept_hash' => convert_string('encrypt', Input::get('dept_hash')),
                    'fe_file' => Input::get('e_file'),
                    'fe_image' => $filename,
                    'fe_status' => 'Active',
                ));
